...
public class BoxBlurFilter extends AbstractBufferedImageOp {
	...
	public static void main(String[] args){
		...
		File imageFile = new File("C:\\Users\\nikhilesh\\Desktop\\Images\\example.jpg");
		try {
...
//		Kernel kernel = new Kernel(9, 9, matrix);
			filter.setVRadius(10);
			filter.setHRadius(10);
			//motion blur
			filter.setHRadius(30);
			filter.setVRadius(0);
			dst = filter.filter(src, null);
			ImageIO.write(dst, "JPEG", new File("C:\\Users\\nikhilesh\\Desktop\\Images\\bird40140.jpg"));
		} catch (IOException e) {
